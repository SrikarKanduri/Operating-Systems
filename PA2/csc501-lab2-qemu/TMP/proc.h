...
struct	pentry	{
	...
	int 	oldprio;		/* save pprio before inheriting */
	int	plwaitret;
	long	lwaittime;		/* waiting time in the lock q	*/
	int 	lockreq[NLOCKS];	/* types of locks requested	*/
	int	lockid;			/* waiting for which lock	*/
};
